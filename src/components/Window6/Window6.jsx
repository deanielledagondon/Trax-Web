...
import { supabase } from '../../staff/components/helper/supabaseClient';
...
const Window6 = () => {
  ...
  return (
    <div className="container mt-5">
      <HeaderStats6 {...monthStats} comments={comments} reviews={reviews} ratingsOverTime={ratingsOverTime} />
