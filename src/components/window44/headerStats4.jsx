...
import './headerStats4.scss';
import { useNavigate } from 'react-router-dom';
import { windowPrintSelection } from '../helper/pdfPrinter'
import window4Proptypes from '../helper/headerPropTypes.js'
  ...
  return (
    <div className="header-stats">
      <div className="header-top">
        ...
        <h2 className="area-top-title">Window 4 | Feedback</h2>
...
HeaderStats.propTypes = window4Proptypes
