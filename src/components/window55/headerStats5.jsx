...
import './headerStats5.scss';
import { useNavigate } from 'react-router-dom';
import { windowPrintSelection } from '../helper/pdfPrinter'
import window5Proptypes from '../helper/headerPropTypes.js'
  ...
  return (
    <div className="header-stats">
      <div className="header-top">
        ...
        <h2 className="area-top-title">Window 5 | Feedback</h2>
...
HeaderStats.propTypes = window5Proptypes
